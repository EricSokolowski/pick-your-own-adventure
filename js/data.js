const chapters = [
  {
    ...
    The world as you know it has changed in the past few years.  King Garner, ‘The Beast’, as he's affectionately known,  has an iron grip on the kingdom at large.  Laws have been harshened to the deathly extreme and resources for the lesser fortunate are stiffened.  Patrol outside the city walls has been limited due to a defunded Nights Guard.  That money was allocated to monthly tourney’s by order of the King himself.  The people who are forced to live outside of the city are rewarded with bandit raids and attacks from beasts most foul.  You are one of these less fortunates.  The air has been thinning around you, life tightens its grasp on your neighbors and people begin to become desperate for help.  You yourself would have been damned if not for your father,  His name is Lambard and as Ex-KingsGuard he has the tools to protect you.  But he's getting old, 65 maybe even 70 he wishes to keep it a secret to not reveal how little time he actually has left.  Today is its own, however, and there is work to do…  Your father has tasked you with collecting firewood from the Bloom Marsh, a wooded swamp about a mile west  from the homestead or fishing for tonight's dinner in the lake behind the kingdom.  The only question now is what to get done first.
    `,
    options: [
      {
        option: `Venture out`,
